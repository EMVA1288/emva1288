...
class Camera(object):
    ...
    def __init__(self,
        ...
        transmition_factor : float, optional
                            The factor who multipliate the radiance if not
                            bayer filter. By default 1.
        t00 : float, optional
              For information see documentation about it in the 'routines.py'.
        t01 : float, optional
              For information see documentation about it in the 'routines.py'.
        t10 : float, optional
              For information see documentation about it in the 'routines.py'.
        t11 : float, optional
              For information see documentation about it in the 'routines.py'.
        transmition_green : float, optional
            This is valid for
            *_green
            *_red
            *_blue
            Transmition of photon in pourcentage in the bayer filter.
            *Warning* - this number are approx. and only true for this
        ...
        prnu : np.array, optional
               ...
               of the image. Every image is multiplied by it aaaa
        """
        ...
        if bayer:
            self.bayer = routines.get_bayer_filter(t00, t01,
                                                   t10, t11,
                                                   self.width,
                                                   self.height)
        else:
            self.bayer = transmition_factor
