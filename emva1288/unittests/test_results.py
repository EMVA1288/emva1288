...
class TestResults(unittest.TestCase):
    ...
    def test_results_with_bayer_filter_0(self):
        dt, p, l, da, r = _init(height=self._height,
                                width=self._width,
                                bit_depth=self._bit_depth,
                                L=self._L,
    ...
    def test_results_with_bayer_filter_1(self):
        dt, p, l, da, r = _init(height=self._height,
                                width=self._width,
                                bit_depth=self._bit_depth,
                                L=self._L,
    ...
    def test_results_with_bayer_filter_2(self):
        dt, p, l, da, r = _init(height=self._height,
                                width=self._width,
                                bit_depth=self._bit_depth,
                                L=self._L,
    ...
    def test_results_with_bayer_filter_3(self):
        dt, p, l, da, r = _init(height=self._height,
                                width=self._width,
                                bit_depth=self._bit_depth,
                                L=self._L,
    ...
    def test_results_with_bayer_filter_error(self):
        dt, p, l, da, r = _init(height=self._height,
                                width=self._width,
                                bit_depth=self._bit_depth,
                                L=self._L,
