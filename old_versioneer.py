...
def get_config_from_root(root):
    ...
    # VCS = parser.get("versioneer", "VCS") or 'git'  # mandatory
    ...
    version_file = os.path.join('emva1288', '_version.py')
    cfg.versionfile_source = get(parser, "versionfile_source") or version_file
    cfg.versionfile_build = get(parser, "versionfile_build") or version_file
    cfg.tag_prefix = get(parser, "tag_prefix") or 'v'
    cfg.parentdir_prefix = get(parser, "parentdir_prefix") or 'emva12888-'
